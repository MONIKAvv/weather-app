...
export default function WeatherCard({temperature,windspeed, humidity, place, heatIndex, iconString, conditions}) {
  ...
  return ( 
    <div className='w-[22rem] min-w-[22rem] h-[32rem] glassCard p-4'>
      ...
      <div className='w-full flex justify-between items-center mt-4'>
        <p className=' justify-center p-2'>{new Date().toDateString()}</p>
        <p className='text-center p-2'>{time}</p>
      </div>
